...
tags = {
  settings = {
    { names  = { "main", "www", "files", "mail", "im" },
      layout = { layouts[2], layouts[1], layouts[1], layouts[4], layouts[6] }
    },
    { names  = { "main", "office", 7,  "media" },
      layout = { layouts[2], layouts[2], layouts[2], layouts[5] }
}}}
...
--    awful.tag({ "main", "www", "office", "files", "5", "6", "7", "sudo", "timetable" }, s, awful.layout.layouts[1])
...
-- Mouse and keyboard bindings switching keyboard layouts
